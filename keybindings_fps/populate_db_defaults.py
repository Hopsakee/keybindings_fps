...
# %% auto 0
__all__ = ['populate_categories', 'populate_modifiers', 'populate_game_keys', 'populate_actions', 'add_binding',
           'create_default_game', 'setup_fresh_db']
...
# %% ../nbs/01_populate_db_defaults.ipynb 8
...
# %% ../nbs/01_populate_db_defaults.ipynb 9
...
# %% ../nbs/01_populate_db_defaults.ipynb 10
def setup_fresh_db():
